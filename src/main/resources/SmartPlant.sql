...
CREATE TABLE `Employee` (
  ...
  CONSTRAINT `employee_ibfk_2` FOREIGN KEY (`positionNo`) REFERENCES `position` (`positionNo`) ON DELETE SET NULL,
  CONSTRAINT `employee_ibfk_3` FOREIGN KEY (`departmentNo`) REFERENCES `department` (`departmentNo`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
